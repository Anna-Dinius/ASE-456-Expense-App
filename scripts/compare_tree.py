...
`docs/file-structure.txt` produced by update_file_tree.py.
...
def main():
    ...
    parser.add_argument('--docs', type=Path, default=Path(__file__).resolve().parent.parent / 'docs' / 'file-structure.txt',
