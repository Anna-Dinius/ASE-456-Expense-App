...
size: 16:9
paginate: true
footer: 'Expense App - User Manual'
---
...
_A practical guide for managing your personal finances_
...
**No more wondering "Where did all my money go?"**
...
Adding an expense is quick and easy!
...
✅ Your expense is now tracked!

---

## Example: Adding Your First Transaction

**Scenario:** You bought lunch for $12.50 today
...
A **budget** is a spending limit for a category.
...
- Check budgets daily or weekly
- Review categories that are turning yellow
...
**Visual analysis helps you understand spending patterns.**
...
**View your overall spending patterns:**
...
- Upward trends (spending increasing)
- Seasonal patterns (higher in winter, etc.)
- Monthly patterns (e.g., always high on payday)
...
**Savings Goals** help you save money for future purchases.

**Examples:**

- Vacation: Target $2,000
- Car down payment: Target $5,000
...
**Reports** provide detailed summaries of your spending over any time period.
...
**Organize your transaction view:**
...
- Your data is automatically backed up to cloud
...
- Enter numbers only: 25.50 (not $25.50)
- Use decimal for cents: 15.99
- Whole dollars don't need decimals: 25 (not 25.00)
...
**Start today. Log your first expense. Set your first budget. Create your first goal.**

Your financial health starts now! 🎉
